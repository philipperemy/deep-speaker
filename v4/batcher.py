...
from utils import parallel_function, ensures_dir
...
def generate_cache_from_training_inputs(cache_output_dir, audio_reader, multi_threading):
    cache_dir = os.path.expanduser(cache_output_dir)
